...
// Feature: Impact report auto-generation for grant submissions
...
export default function CfImpactReportAutoGenerationForGrantSubmissions() {
  ...
  const submit = async (e) => {
    ...
    try {
      const res = await fetch(`${API_BASE}/api/cf-impact-report-auto-generation-for-grant-submissions/run`, {
        method: 'POST', headers: getHeaders(),
        body: JSON.stringify({ prompt: input, feature: 'cf-impact-report-auto-generation-for-grant-submissions', project: 'AIVolunteerMatchingManagement' })
      })
  ...
  const loadHistory = async () => {
    try {
      const res = await fetch(`${API_BASE}/api/cf-impact-report-auto-generation-for-grant-submissions/history`, { headers: getHeaders() })
      const data = await res.json()
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      <div className="mb-4">
        <h1 className="text-2xl font-bold text-slate-800">Impact report auto-generation for grant submissions</h1>
